			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">请输入销项发票信息：</h3>
					</div>
					<div class="panel-body">
						<form action="cn.edu.gdpu.servlet/addoutputservlet" id="addForm" method="post">
							<fieldset>
								...
								<select class="form-control" name="type">
									<option >请选择发票类型</option>
								  	<option value ="1">预防药物</option>
								  	<option value ="2">诊断药物</option>
								  	<option value="3">治疗药物</option>
								  	<option value="4">药剂附加药物</option>
								  	<option value="5">其他药物</option>
								</select>
								<br>
