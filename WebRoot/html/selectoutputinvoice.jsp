			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="index.jsp" class="site_title"> <span>发票数据分析系统</span>
						</a>
					</div>
...
<!-- 										<li><a href="cn.edu.gdpu.servlet/contrastmonth">月度统计</a>
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<%
						Properties pro = (Properties) request.getSession().getAttribute(
											"pro");
									String code = "";
									String number = "";
									String customer = "";
	...
	int recordCount; //总记录数%>
									<%
										PageController pc = (PageController) session.getAttribute("pc");
																	outputdao put = new outputdao();
																	recordCount = pc.getRecordCount();
																	showPage = pc.getShowPage();
																	List<outputinvoice> p = (List<outputinvoice>) request.getAttribute("list");
								...
								<div class="pageNav">
									<ul class="pagination pagination-lg">
										...
										%>
										<li><a href="servlet/OutputListServlet?showPage=<%=i%>"><%=i%></a>
										</li>
										<%
											}
																			}
										...
										<li><a
											href="servlet/OutputListServlet?showPage=<%=pc.getNextPage()%>"
											aria-label="Next"> <span aria-hidden="true">下一页</span> </a>
										</li>
										<li><a
											href="servlet/OutputListServlet?showPage=<%=pc.getPageCount()%>">
